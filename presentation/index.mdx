...
import { Box, Flex, Stack, Square, Copy } from '@grubhubprod/gh-cookbook-react' ;
...
<Box my={75}>
  ...
  <Appear>
    <Square inset={10}>
      <Text>Hard to refactor/remove dead styles</Text>
    </Square>
  </Appear>
  <Appear>
    <Square inset={10}>
      <Text>Naming fatigue</Text>
    </Square>
  </Appear>
</Box>
...
<Square mt={20} inset={5}>
  <a target="_blank" href="https://codepen.io/bennybrau/pen/JVwGzo">Quick example</a>
</Square>
...
<Box mt={60}>
  <Appear>
    <Square inset={10}>
      <Text>Isolates styles to the component</Text>
    </Square>
  </Appear>
  <Appear>
    <Square inset={10}>
      <Text>Idiomatic to React - props</Text>
    </Square>
  </Appear>
  <Appear>
    <Square inset={10}>
      <Text>Only renders critical CSS</Text>
    </Square>
  </Appear>
  <Appear>
    <Square inset={10}>
      <Text>Reuses what's existing</Text>
    </Square>
  </Appear>
  <Appear>
    <Square inset={10}>
      <Text>Automates CSS selector naming</Text>
    </Square>
  </Appear>
  <Appear>
    <Square inset={10}>
  ...
  <Appear>
    <Square inset={10}>
      <Text>No additional build step</Text>
    </Square>
  </Appear>
</Box>
...
<Box mt={50}>
  ...
  <Appear>
    <Square inset={10}>
      <Text>before <code>mount</code>, the template literal is evaluated</Text>
    </Square>
  </Appear>
  <Appear>
    <Square inset={10}>
...
<Notes>
  Show the example from Kurts promo exercise.
</Notes>
...
* [The state of CSS in JS](https://medium.com/@vviikk/the-state-of-css-css-in-js-how-styled-components-is-solving-the-problems-weve-had-for-decades-d8abbc8bc148)
* [Server Side Rendering with Styled-components](https://medium.com/swlh/server-side-rendering-styled-components-with-nextjs-1db1353e915e)
* [Our Cookbook Storybook](http://cookbook-web-react.ghbeta.com/)

---

<BGImage src={require('file-loader!./images/tsarbomba.jpg')} />
<Box>
  <Stack y="md">That's all folks.</Stack>
  Questions?
</Box>
